...
class EbookUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'book_id' => "required|min:3|max:25|unique:ebooks,book_id,$id||spaceNotAllow",
            ...
            'thumbnail_img' => 'nullable|file|image|mimes:jpeg,jpg,png|between:5,1024|dimensions:height=300,width=200',
